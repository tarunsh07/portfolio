...
export function HeroScrollVideo({ videoUrl }: HeroScrollVideoProps) {
  ...
  return (
    <section ref={containerRef} className="relative h-[350lvh]">
      ...
      <div className="sticky top-0 h-[100lvh] w-full overflow-hidden bg-[#000000]">
        ...
        <div className="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-t from-[#000000] to-transparent z-10" />
        <div className="absolute inset-0 bg-black/20 z-0" />

        {/* Text Content */}
        <div className="absolute inset-0 z-20 pointer-events-none">
          {/* Top Greeting */}
          <motion.p style={{ opacity: textOpacity }} className="absolute top-[6vh] left-1/2 -translate-x-1/2 text-lg xl:text-2xl font-serif italic text-white/80 whitespace-nowrap">
            Hello, I’m
          </motion.p>

          {/* Center Name Split */}
          <div className="absolute inset-0 flex flex-col items-center justify-start pt-[12vh] pb-0 xl:flex-row xl:items-center xl:justify-between xl:px-32 xl:pt-0">
            <motion.h1 style={{ opacity: textOpacity }} className="text-[2.75rem] sm:text-[4rem] xl:ml-24 xl:text-7xl font-serif italic font-medium tracking-[6px] text-transparent bg-clip-text bg-gradient-to-br from-[#F8F4FF] via-[#E8F2FF] to-[#FFDCCB]/20">
              Tarun
            </motion.h1>
            <motion.h1 style={{ opacity: textOpacity }} className="text-[2.75rem] sm:text-[4rem] xl:mr-20 xl:text-7xl font-serif italic font-medium tracking-[6px] text-transparent bg-clip-text bg-gradient-to-br from-[#F8F4FF] via-[#E8F2FF] to-[#FFDCCB]/20 -mt-4 xl:mt-0">
              Sharma
            </motion.h1>
          </div>
          ...
          <motion.div style={{ opacity: textOpacity }} className="absolute bottom-0 left-1/2 -translate-x-1/2 flex flex-col items-center">
            <p className="text-xs xl:text-sm text-white/50 mb-3 tracking-[0.3em] uppercase font-light whitespace-nowrap">Code • Create • Evolve</p>
