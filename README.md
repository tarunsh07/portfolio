<div align="center">
  <img src="public/projectimages/fav-zoomed.webp" alt="Tarun Sharma Logo" width="120" />

  # Tarun Sharma | Developer Portfolio
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/tarunsh07/portfolio.git
   ```
